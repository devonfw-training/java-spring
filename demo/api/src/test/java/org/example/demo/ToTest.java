...
public class ToTest extends ModuleTest {
  ...
  /**
   * Finds all {@link AbstractTo Transportobjekte} of this app via reflection and tests all getters/setters as well as
   * equals and hashCode.
   */
  @Test
  public void testTos() {
   ...
   * @return boolean value if the class to be checked has a custom equals() method or not
   */
   ...
   *
   * @param clazz class to be checked
   * @return boolean value if the class to be checked has a custom hashCode() method or not
   */
