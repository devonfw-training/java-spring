...
image::images/Entities.png[width="80%"]
...
=== Create JUnits
Now you can create JUnit tests like this:

[source,sql]
----
@SpringBootTest(classes = SpringBootApplication.class, webEnvironment = WebEnvironment.MOCK)
