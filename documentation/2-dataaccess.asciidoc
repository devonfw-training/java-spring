...
* Now start your server and go to _http://localhost:8081/h2-console_. If this gives you an 403 or 404, you might have set a value for _server.servlet.context-path_ in your application.properties. Than you have to put it in the URL as path prefix.
